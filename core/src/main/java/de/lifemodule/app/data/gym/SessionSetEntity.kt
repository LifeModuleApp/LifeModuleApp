...
/**
 * One performed set within a training session.
 * For cardio: only durationSeconds is relevant.
 * For strength: reps + weightKg define the set (e.g. 7 x 30 kg).
 */
@Entity(
