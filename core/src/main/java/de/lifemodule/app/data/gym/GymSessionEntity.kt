...
/**
 * An actual training session that the user performed.
 * Can be based on a WorkoutEntity template or a completely free session.
 */
@Entity(
    tableName = "gym_sessions",
    indices = [Index("date"), Index("workoutTemplateId")]
)
data class GymSessionEntity(
    ...
    /** UUID of the WorkoutEntity template this session was started from, or null for freestyle. */
